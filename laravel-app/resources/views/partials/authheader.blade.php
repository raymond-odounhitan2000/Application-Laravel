        ...
        <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                        ...
                        class='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Create_articles
                        </a>
                    </li>
                </ul>
            </div>
            <div class='flex max-lg:ml-auto space-x-3'>
                ...
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <button class='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff]'>Logout</button>
                </a>
